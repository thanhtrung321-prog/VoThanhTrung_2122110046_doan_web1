...
return new class extends Migration
{
    ...
    {
        Schema::create('vothanhtrung_category', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('parent_id')->default(0); // parent_id INT UNSIGNED DEFAULT 0
    ...
    {
        Schema::dropIfExists('vothanhtrung_category');
    }
};
